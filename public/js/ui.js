...
function switchTab(tab, saveState = true) {
    if (tab === 'geminicli') tab = 'tokens';
    // 更新html元素的class以防止闪烁
    document.documentElement.classList.remove('tab-settings', 'tab-logs', 'tab-geminicli', 'tab-flow', 'tab-catalog');
    if (tab === 'settings') {
        ...
        document.documentElement.classList.add('tab-flow');
    } else if (tab === 'catalog') {
        document.documentElement.classList.add('tab-catalog');
    }
    ...
    if (flowPage) {
        flowPage.classList.add('hidden');
        flowPage.classList.remove('page-enter');
    }
    if (catalogPage) {
        catalogPage.classList.add('hidden');
        catalogPage.classList.remove('page-enter');
    }
    ...
    if (tab === 'tokens') {
        ...
        if (flowPage) {
            flowPage.classList.remove('hidden');
            void flowPage.offsetWidth;
            flowPage.classList.add('page-enter');
            if (typeof initFlowPage === 'function') initFlowPage();
        }
    } else if (tab === 'catalog') {
        if (catalogPage) {
            catalogPage.classList.remove('hidden');
            void catalogPage.offsetWidth;
            catalogPage.classList.add('page-enter');
...
function restoreTabState() {
    ...
    if (savedTab && (savedTab === 'tokens' || savedTab === 'settings' || savedTab === 'logs' || savedTab === 'flow' || savedTab === 'catalog')) {
